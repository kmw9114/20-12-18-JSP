...
<body>
  ...
  <!-- Main Content -->
  <div class="container">
	<form action="update2.do" method="post" class="form-horizobtal">
			<div class="form-group" align="" >
        		...
        		<input type="text" name="title" value="${dto.title}" onfocus="" class="form-control" style="width:800px"/>
        	 	</div>
			</div>
			
        	<br>
        	<div class="inputarea">
        	<textarea id="abouttext"  name="content">${dto.content}</textarea>
        		<script>
        			var ckeditor_config = {
			...
			<div class="form-group" align="">
				<div class="col-sm-4" >
					<input type="text"  name="writer" value="${dto.writer}" onfocus=""   class="form-control"/>
        		</div>
			</div>
			<!--  <br><br>
			<div align="center">
